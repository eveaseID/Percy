    ...
    <div class="swiper-container">
        <div>
            ...
            <section class="islands">
                <img
                    src="{{ asset('frontend/assets/img/percy.jpeg') }}"
                    alt=""
                    class="islands__bg"
                />
                    ...
                    <div class="islands__container container">
                        ...
                        >
                            ...
                            <p class="islands__description">
                                Feels not save in this world? <br />
                                Join Us we promise giving you best accomodation
                            </p>
                        </div>
                    </div>
                </div>
...
>
    <div class="logos__container container grid">
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/percyy.jpeg') }}" alt="" />
        </div>
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/anna.jpeg') }}" alt="" />
        </div>
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/grover.jpeg') }}" alt="" />
        </div>
    </div>
</section>
    ...
    <div class="value__container container grid">
        <div class="value__images">
            ...
            <div class="value__img">
                <img src="{{ asset('frontend/assets/img/camp.jpeg') }}" alt="" />
            </div>
        </div>
